...
помогает превратить продуктовую идею и принятую на её основе концепцию в
машиночитаемую операционную карту полного пути продукта.
...
Репозиторий распространяется по Business Source License 1.1. Additional Use
Grant разрешает некоммерческое production-использование; для коммерческого
production-использования требуется отдельная лицензия. Подробнее — в разделе
[Лицензия](#лицензия).
...
- Версия 0.2.2 реализует операционную карту и пространство ревью, но не всю будущую платформу планирования и мультиагентного выполнения TASKPLAN PRO.
...
Продукт распространяется по [Business Source License 1.1](LICENSE). Additional
Use Grant разрешает некоммерческое production-использование. Для коммерческого
production-использования требуется отдельная лицензия от лицензиара.

21 июля 2030 года — либо не позднее четвёртой годовщины первой публичной
публикации этой лицензируемой версии — продукт перейдёт на GPL-2.0-or-later.
До перехода BSL 1.1 является source-available лицензией, но не OSI-approved
